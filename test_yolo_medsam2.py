...
class YOLOSAM2Predictor:
    def __init__(self, 
                 ...
                 sam2_checkpoint="./pretainmodels/MedSAM2_latest.pt",
    ...
    def evaluate_dataset(self, test_data_path="./datasets/ISIC2017/segmentation_format/test"):
        ...
        for img_file in tqdm(image_files, desc="Evaluating YOLO+MedSAM2"):
        ...
        with open("./test_results/yolo_medsam2_results.json", 'w') as f:
