...
from train_unet import UNet, SkinLesionDataset
import json
...
class UNetEvaluator:
    def __init__(self, model_path="./saved_models/unet_skin_lesion.pth"):
    ...
    def evaluate_dataset(self, test_data_path="./datasets/ISIC2017"):
        """Evaluate U-Net on test dataset"""
        # Create test dataset
        ...
        with torch.no_grad():
            for i, (image, gt_mask) in enumerate(tqdm(test_loader, desc="Evaluating U-Net")):
        ...
        with open("./test_results/unet_results.json", 'w') as f:
